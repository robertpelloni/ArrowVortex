...
E(OPEN_DIALOG_CHART_STATISTICS)
E(OPEN_DIALOG_TEMPO_BREAKDOWN)
E(OPEN_DIALOG_LYRICS_EDITOR)
E(OPEN_DIALOG_BG_CHANGES)
...
E(TOGGLE_RECORD_MODE)
E(TOGGLE_PRACTICE_MODE)
...
E(DETECT_SONG_SECTIONS)
E(ESTIMATE_BPM_FROM_SELECTION)
E(AUTO_SYNC_SONG)
E(AUTO_SYNC_SECTIONS)
E(CONVERT_REGION_TO_CONSTANT_BPM)
E(SNAP_OFFSET_TO_FIRST_BEAT)
E(QUANTIZE_TO_AUDIO)
E(WARP_GRID_TO_AUDIO)
E(PLACE_BEAT_AT_PLAYHEAD)

E(VERIFY_CHART_INTEGRITY)
E(SELECT_OFF_SYNC_NOTES)

E(NUDGE_BEAT_FORWARD)
E(NUDGE_BEAT_BACKWARD)
...
E(TOGGLE_LOOP_SELECTION)
E(TOGGLE_BEAT_TICK)
E(TOGGLE_NOTE_TICK)

E(TOGGLE_SHOW_WAVEFORM)
E(TOGGLE_SHOW_SPECTROGRAM)
...
E(CURSOR_CHART_END)
E(CURSOR_NEXT_TRANSIENT)
E(CURSOR_PREV_TRANSIENT)
