...
//==================================================================
template <class T>
void MFCC<T>::calculateMelFrequencyCepstralCoefficients (const std::vector<T>& m
agnitudeSpectrum)
{
...
//==================================================================
template <class T>
void MFCC<T>::calculateMelFrequencySpectrum (const std::vector<T>& magnitudeSpec
trum)
{
    for (int i = 0; i < numCoefficents; i++)
    {
        ...
        for (size_t j = 0; j < magnitudeSpectrum.size(); j++)
            coeff += (T)((magnitudeSpectrum[j] * magnitudeSpectrum[j]) * filterB
ank[i][j]);
...
//==================================================================
template <class T>
void MFCC<T>::discreteCosineTransform (std::vector<T>& inputSignal, const std::s
ize_t numElements)
{
    // the input signal must have the number of elements specified in the numEle
ments variable
