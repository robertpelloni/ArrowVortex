...
//===========================================================
template <class T>
T CoreFrequencyDomainFeatures<T>::spectralCentroid (const std::vector<T>& magnit
udeSpectrum)
{
    ...
    // if the sum of amplitudes is larger than zero (it should be if the buffer
wasn't
    // all zeros)
    if (sumAmplitudes > 0)
    {
        // the spectral centroid is the sum of weighted amplitudes divided by th
e sum of amplitdues
...
//===========================================================
template <class T>
T CoreFrequencyDomainFeatures<T>::spectralFlatness (const std::vector<T>& magnit
udeSpectrum)
{
    double sumVal = 0.0;
...
//===========================================================
template <class T>
T CoreFrequencyDomainFeatures<T>::spectralCrest (const std::vector<T>& magnitude
Spectrum)
{
    T sumVal = 0.0;
    T maxVal = 0.0;
...
//===========================================================
template <class T>
T CoreFrequencyDomainFeatures<T>::spectralRolloff (const std::vector<T>& magnitu
deSpectrum, T percentile)
{
    T sumOfMagnitudeSpectrum = std::accumulate (magnitudeSpectrum.begin(), magni
tudeSpectrum.end(), 0);
...
//===========================================================
template <class T>
T CoreFrequencyDomainFeatures<T>::spectralKurtosis (const std::vector<T>& magnit
udeSpectrum)
{
