...
public:
    ...
    //===========================================================
    /** calculates the spectral centroid given the first half of the magnitude s
pectrum
     of an audio signal. Do not pass the whole (i.e. mirrored) magnitude spectru
m into
     this function or you will always get the middle index as the spectral centr
oid
     @param magnitudeSpectrum the first half of the magnitude spectrum (i.e. not
 mirrored)
    ...
    //===========================================================
    /** calculates the spectral flatness given the first half of the magnitude s
pectrum
     of an audio signal.
     @param magnitudeSpectrum the first half of the magnitude spectrum (i.e. not
 mirrored)
    ...
    //===========================================================
    /** calculates the spectral crest given the first half of the magnitude spec
trum
     of an audio signal.
     @param magnitudeSpectrum the first half of the magnitude spectrum (i.e. not
 mirrored)
    ...
    //===========================================================
    /** calculates the spectral rolloff given the first half of the magnitude sp
ectrum
     of an audio signal.
     @param magnitudeSpectrum the first half of the magnitude spectrum (i.e. not
 mirrored)
     ...
     */
    T spectralRolloff (const std::vector<T>& magnitudeSpectrum, T percentile = 0
.85);

    //===========================================================
    /** calculates the spectral kurtosis given the first half of the magnitude s
pectrum
     of an audio signal.
     @param magnitudeSpectrum the first half of the magnitude spectrum (i.e. not
 mirrored)
