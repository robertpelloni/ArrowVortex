...
public:
     ...
     * @returns the energy difference onset detection function sample for the fr
ame
     */
    ...
    //===========================================================
    /** calculates the complex spectral difference from the real and imaginary p
arts
     * of the FFT
     ...
     */
    T complexSpectralDifference (const std::vector<T>& fftReal, const std::vecto
r<T>& fftImag);
...
private:
    ...
    //===========================================================
    /** holds the previous energy sum for the energy difference onset detection
function */
    T prevEnergySum;
