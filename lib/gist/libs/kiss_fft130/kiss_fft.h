 ...
 *
 *  If lenmem is NULL, then kiss_fft_alloc will allocate a cfg buffer using mall
oc.
...
/*
 ...
 sample.
 * */
void kiss_fft_stride(kiss_fft_cfg cfg,const kiss_fft_cpx *fin,kiss_fft_cpx *fout
,int fin_stride);
